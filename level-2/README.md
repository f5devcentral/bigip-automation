# Adding Version Control to the Automation Framework
...
Open the `VS Code` terminal and clone `tf-level-2` from the internally hosted GitLab.
```
git clone https://root:Ingresslab123@git.f5k8s.net/bigip/tf-level-2.git
```
...
- **Commit Hash**: A unique identifier (SHA) for the commit where the change was made.
- **Date and Time**: The date and time when the change was made.

<p align="center">
  <img src="../images/blame.png" style="width:75%">
</p>
...
<p align="center">
  <img src="../images/history.png" style="width:75%">
</p>
